...
namespace TweetDuck.Browser.Notification {
	abstract class NotificationScreen {
		...
		public class SameAsTweetDuck : NotificationScreen {
		...
		private class Static : NotificationScreen {
		...
		private class Provided : NotificationScreen {
			...
			private class WindowsFormsScreenLayout : IScreenLayout {
				...
				public List<IScreen> AllScreens => Screen.AllScreens.Select(screen => new WindowsFormsScreen(screen)).ToList<IScreen>();
			...
			private class WindowsFormsScreen : IScreen {
		...
		public static readonly SingleTypeConverter<NotificationScreen> Converter = new SingleTypeConverter<NotificationScreen> {
			ConvertToString = value => value.Serialize(),
